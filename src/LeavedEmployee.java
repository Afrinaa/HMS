...
public class LeavedEmployee extends javax.swing.JFrame {
    ...
    public LeavedEmployee() {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM employee WHERE status = 'Leaved'");
            while(rs.next()) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Mobile Number", "Father Name", "Mother Name", "Parmanent Address", "Present Address", "NID Number ", "Designation"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(32, 57, 638, 390));
